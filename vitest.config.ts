...
export default defineConfig({
  ...
  test: {
    ...
    include: [
      ...
      "components/pages/__tests__/pricing-enterprise-page.test.tsx",
      ...
      "components/team/__tests__/team-nav-items.test.ts",
      "components/pages/__tests__/team-invite-gating.test.tsx",
      "components/pages/__tests__/team-member-group-visibility.test.tsx",
      "components/pages/__tests__/team-overview-filter-failure.test.tsx",
      "components/pages/__tests__/team-roster-stale-response.test.tsx",
      "components/pages/__tests__/team-pending-invites.test.tsx",
      "components/pages/__tests__/team-overview-filter-transition.test.tsx",
      "components/pages/__tests__/team-overview-recovery-flash.test.tsx",
      "components/pages/__tests__/team-leaderboard-group-filter.test.tsx",
      ...
      "components/pages/__tests__/learning-paths-team-section.test.tsx",
