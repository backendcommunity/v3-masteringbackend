...
export function HeroVideo() {
  return (
    <div className="relative w-full h-full rounded-2xl overflow-hidden">
      {/* Video Background */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0E1F33] to-[#13AECE] opacity-90"></div>

      {/* Animated Code Simulation */}
      <div className="absolute inset-0 p-6 text-green-400 font-mono text-sm overflow-hidden">
        <div className="space-y-2 animate-pulse">
          <div className="text-blue-300">// Building scalable backend systems</div>
          ...
          <div className="text-purple-300">console.log('Server running...');</div>
