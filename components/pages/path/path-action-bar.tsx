  ...
  return (
    <div className="relative z-10 flex w-full min-w-0 flex-shrink-0 items-center bg-transparent px-4 py-3 sm:px-8 sm:py-4 lg:px-16">
      ...
      <Button
        ...
        onClick={handleNext}
        disabled={atEnd}
        className="h-11 rounded-xl bg-gradient-to-br from-primary to-[#2BB8D8] px-6 text-sm font-extrabold text-[#06222b] shadow-[0_6px_20px_-4px_rgba(19,174,206,0.5)] hover:brightness-110 hover:from-primary hover:to-[#2BB8D8] disabled:pointer-events-none disabled:opacity-40"
      >
