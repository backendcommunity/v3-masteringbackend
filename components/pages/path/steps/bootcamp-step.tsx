      ...
      <div className="p-6 max-w-2xl mx-auto">
        <div className="rounded-2xl border border-border bg-card card-glow p-8 space-y-5">
          <div className="flex items-center justify-between gap-3">
            <span className="w-14 h-14 rounded-2xl bg-[#F2C94C]/15 text-[#F2C94C] flex items-center justify-center glow-subtle">
          ...
          <p className="text-muted-foreground font-medium">
            Live cohort session for this milestone.
          </p>
          <Button
            onClick={() => onNavigate(`/bootcamps/${step.itemId}`)}
