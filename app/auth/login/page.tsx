    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E8F4F8] via-white to-[#97C3CC]/20 dark:from-[#0A0F1C] dark:via-[#1E293B] dark:to-[#0F172A] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#0E1F33] dark:text-[#F1F5F9] mb-2">Welcome Back</h1>
          <p className="text-[#0E1F33]/70 dark:text-[#94A3B8]">Sign in to continue your backend journey</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                />
                <span className="text-sm text-[#0E1F33] dark:text-[#F1F5F9]">Remember me</span>
              </label>
              <a
