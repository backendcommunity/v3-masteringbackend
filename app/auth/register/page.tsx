...
import { Eye, EyeOff, Github, ArrowLeft, Loader2, Check, X } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E8F4F8] via-white to-[#97C3CC]/20 dark:from-[#0A0F1C] dark:via-[#1E293B] dark:to-[#0F172A] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-[#0E1F33] dark:text-[#F1F5F9] mb-2">Start Your Journey</h1>
          <p className="text-[#0E1F33]/70 dark:text-[#94A3B8]">Create your account and transform your backend career</p>
        </div>
        ...
        <div className="glass-card p-8 rounded-2xl shadow-xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="lastName" className="block text-sm font-medium text-[#0E1F33] dark:text-[#F1F5F9] mb-2">
                  Last Name
                </label>
                <input
                  type="text"
            ...
            <div className="space-y-3">
              <label className="flex items-start space-x-3 cursor-pointer">
                ...
                <span className="text-sm text-[#0E1F33] dark:text-[#F1F5F9]">
                  I agree to the{" "}
                  <a href="#" className="text-[#13AECE] dark:text-[#0EA5E9] hover:underline">
                    Terms of Service
                  </a>{" "}
                  and{" "}
                  <a href="#" className="text-[#13AECE] dark:text-[#0EA5E9] hover:underline">
