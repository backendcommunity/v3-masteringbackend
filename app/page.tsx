    ...
    <div className="min-h-screen bg-white dark:bg-[#0A0F1C] transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <ThemeToggle />
              <button className="bg-[#0E1F33] dark:bg-[#0EA5E9] text-white px-6 py-2 rounded-lg hover:bg-[#0E1F33]/90 dark:hover:bg-[#0284C7] transition-all">
                Get Started
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="text-center mb-16 max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
              <button className="group bg-[#0E1F33] dark:bg-[#0EA5E9] text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[#0E1F33]/90 dark:hover:bg-[#0284C7] transition-all transform hover:scale-105">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-8">
            <button className="bg-[#0E1F33] dark:bg-[#0EA5E9] text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[#0E1F33]/90 dark:hover:bg-[#0284C7] transition-all transform hover:scale-105">
                ...
                <div className="flex space-x-4">
                  ...
                  >
                    <svg
                      ...
                      viewBox="0 0 24 24"
                    >
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12 24 2\" />\
