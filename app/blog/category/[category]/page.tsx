...
const categoryData = {
  python: {
    name: "Python",
    description: "Master Python backend development with FastAPI, Django, and modern Python practices.",
    color: "bg-blue-600",
    posts: [
      {
        id: 1,
  ...
  javascript: {
    name: "JavaScript",
    description: "Modern JavaScript backend development with Node.js, Express, and cutting-edge frameworks.",
    color: "bg-yellow-600",
    posts: [
      {
        id: 4,
    ...
    return (
      <div className="min-h-screen bg-white dark:bg-[#0A0F1C] flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-[#0E1F33] dark:text-[#F1F5F9] mb-4">Category Not Found</h1>
    ...
    <div className="min-h-screen bg-white dark:bg-[#0A0F1C] transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center space-x-4 mb-6">
            <div className={`w-16 h-16 ${category.color} rounded-2xl flex items-center justify-center`}>
              <span className="text-white font-bold text-2xl">{category.name.slice(0, 2)}</span>
            </div>
            <div>
              <h1 className="text-4xl md:text-5xl font-bold text-[#0E1F33] dark:text-[#F1F5F9]">{category.name}</h1>
              <p className="text-xl text-[#0E1F33]/70 dark:text-[#94A3B8] mt-2">{category.description}</p>
            </div>
          </div>
                  ...
                  <article className="glass-card rounded-xl overflow-hidden hover:shadow-lg transition-all duration-300 group-hover:scale-[1.02]">
                    ...
                    <div className="p-6">
                      <div className="flex items-center space-x-4 mb-3">
                        <span className="text-[#13AECE] dark:text-[#0EA5E9] text-sm font-medium">{category.name}</span>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0E1F33] dark:bg-[#0A0F1C]">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Master {category.name}</h2>
          <p className="text-white/80 dark:text-[#CBD5E1] mb-8 max-w-2xl mx-auto">
            Get the latest {category.name.toLowerCase()} tutorials, best practices, and insights delivered to your
            inbox.
          </p>
